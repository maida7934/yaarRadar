...
// Real pixel-art normal/pressed pair (see public/pixelated-icons/request-
// boxes.png, the template these were cropped from -- normal only had one
// state, so the -pressed variants were generated by recoloring just the
// interior fill, same technique as PixelButton's pill sprites) -- not a
// CSS-simulated bevel.
function RequestPillButton({
  normalSrc,
  pressedSrc,
  pressedTextColor,
  onClick,
    ...
    >
      ...
      <div className="flex gap-1.5 shrink-0">
        <RequestPillButton
          ...
          onClick={onAccept}
          disabled={disabled}
          style={{ width: 60, height: 28, color: "#ffffff" }}
        >
          ACCEPT
        </RequestPillButton>
        <RequestPillButton
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-bold text-white tracking-widest">ACCOUNT DETAILS</h2>
              </div>
              <button
                type="button"
                onClick={() => setViewingRequest(null)}
        ...
        >
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 text-[#97afc7] text-lg leading-none select-none">✦</div>
                <h2 className="text-sm font-bold text-white tracking-widest">FRIEND PROFILE</h2>
              </div>
              <button
                type="button"
                onClick={() => setViewingFriend(null)}
